...
public class CropProduceCategory implements IRecipeCategory<AgriPlant> {
	...
	public static final Identifier ID = Identifier.fromNamespaceAndPath(AgriApi.MOD_ID, "jei/produce");
	public static final RecipeType<AgriPlant> TYPE = new RecipeType<>(ID, AgriPlant.class);

	public static final IDrawable ICON = AgriCraftJeiPlugin.createDrawable(Identifier.fromNamespaceAndPath(AgriApi.MOD_ID, "textures/item/debugger.png"), 0, 0, 16, 16, 16, 16);
	...
	@Override
	public void draw(AgriPlant recipe, IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
