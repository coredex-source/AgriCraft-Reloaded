...
public class PlantsDatagen {
	...
	public static void registerPlants(BootstrapContext<AgriPlant> context) {
		...
		minecraft(context, "brown_mushroom", new AgriPlant.Builder().seeds(AgriSeed.builder().item("minecraft:brown_mushroom").chances(0.0, 1.0, 0.0).build()).stages16().chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:brown_mushroom").count(2, 5, 1.0).build()).requirement(AgriRequirement.builder().humidity(DAMP, EQUAL, 0.15).acidity(NEUTRAL, EQUAL, 0.2).nutrients(MEDIUM, EQUAL_OR_LOWER, 0.2).light(0, 10, 0.5).seasons(SPRING, SUMMER, AUTUMN, WINTER).build()).modifiers(new AgriPlantModifierInfo(MinecraftPlantModifiers.TreePlantModifier.ID, "minecraft:brown_mushroom")).build());
		minecraft(context, "cactus", new AgriPlant.Builder().seeds(AgriSeed.builder().item("minecraft:cactus").chances(0.0, 1.0, 0.0).overridePlanting(false).build()).stages16().chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:cactus").count(1, 3, 1.0).build()).requirement(AgriRequirement.builder().humidity(ARID, EQUAL, 0.34).acidity(NEUTRAL, EQUAL, 0.2).nutrients(LOW, EQUAL_OR_HIGHER, 0.1).light(10, 16, 0.5).seasons(SUMMER).build()).modifiers(new AgriPlantModifierInfo(MinecraftPlantModifiers.ThornsPlantModifier.ID)).build());
		...
		minecraft(context, "red_mushroom", new AgriPlant.Builder().seeds(AgriSeed.builder().item("minecraft:red_mushroom").chances(0.0, 1.0, 0.0).build()).stages16().chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:red_mushroom").count(2, 4, 1.0).build()).requirement(AgriRequirement.builder().humidity(DAMP, EQUAL, 0.15).acidity(NEUTRAL, EQUAL, 0.2).nutrients(MEDIUM, EQUAL_OR_LOWER, 0.2).light(0, 10, 0.5).seasons(SPRING, SUMMER, AUTUMN, WINTER).build()).modifiers(new AgriPlantModifierInfo(MinecraftPlantModifiers.TreePlantModifier.ID, "minecraft:red_mushroom")).build());
		...
		minecraft(context, "seagrass", new AgriPlant.Builder().seeds(AgriSeed.builder().item("minecraft:seagrass").overridePlanting(false).build()).stages16().chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:seagrass").count(1, 1, 0.75).build()).requirement(AgriRequirement.builder().humidity(WATERY, EQUAL_OR_HIGHER, 0.4).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(MEDIUM, EQUAL_OR_HIGHER, 0.1).light(5, 16, 0.5).seasons(SPRING, SUMMER, AUTUMN, WINTER).fluid(AgriFluidCondition.builder().fluid("minecraft:water").build()).build()).build());
		minecraft(context, "sea_pickle", new AgriPlant.Builder().seeds(AgriSeed.builder().item("minecraft:sea_pickle").overridePlanting(false).build()).stages16().chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:sea_pickle").count(1, 1, 0.75).build()).requirement(AgriRequirement.builder().humidity(WATERY, EQUAL_OR_HIGHER, 0.4).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(MEDIUM, EQUAL_OR_HIGHER, 0.1).light(0, 16, 0.5).seasons(SPRING, SUMMER, AUTUMN, WINTER).fluid(AgriFluidCondition.builder().fluid("minecraft:water").build()).build()).build());
		minecraft(context, "sugar_cane", new AgriPlant.Builder().seeds(AgriSeed.builder().item("minecraft:sugar_cane").chances(0.0, 1.0, 0.0).overridePlanting(false).build()).stages16().chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:sugar_cane").count(1, 2, 1000.0).build()).requirement(AgriRequirement.builder().humidity(WET, EQUAL, 0.15).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(HIGH, EQUAL_OR_HIGHER, 0.1).light(10, 16, 0.5).seasons(SUMMER).build()).build());
		minecraft(context, "sweet_berries", new AgriPlant.Builder().seeds(AgriSeed.builder().item("minecraft:sweet_berries").build()).stages16().chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:sweet_berries").count(1, 1, 0.75).build()).requirement(AgriRequirement.builder().humidity(DAMP, EQUAL, 0.15).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(MEDIUM, EQUAL_OR_HIGHER, 0.1).light(10, 16, 0.5).seasons(SPRING, SUMMER, AUTUMN).build()).modifiers(new AgriPlantModifierInfo(MinecraftPlantModifiers.ThornsPlantModifier.ID), new AgriPlantModifierInfo(MinecraftPlantModifiers.BushyPlantModifier.ID)).build());
		minecraft(context, "torchflower", new AgriPlant.Builder().seeds(AgriSeed.builder().item("minecraft:torchflower_seeds").overridePlanting(false).build()).stages(2, 3, 5, 6, 8, 9, 11, 12).chances(0.65, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:orange_dye").count(1, 1, 0.75).build()).clips(AgriProduct.builder().item("minecraft:torchflower").count(0, 1, 0.5).build()).requirement(AgriRequirement.builder().humidity(DAMP, EQUAL, 0.2).acidity(SLIGHTLY_ACIDIC, EQUAL, 0.2).nutrients(VERY_HIGH, EQUAL_OR_HIGHER, 0.2).light(10, 16, 0.5).seasons(SPRING).build()).build());
		minecraft(context, "warped_fungus", new AgriPlant.Builder().seeds(AgriSeed.builder().item("minecraft:warped_fungus").chances(0.0, 1.0, 0.0).overridePlanting(false).build()).stages(2, 3, 5, 6, 8, 9, 11, 12).chances(0.65, 0.025, 0.1).products(AgriProduct.builder().item("minecraft:warped_fungus").count(2, 5, 1.0).build()).requirement(AgriRequirement.builder().humidity(ARID, EQUAL, 0.15).acidity(HIGHLY_ALKALINE, EQUAL, 0.2).nutrients(LOW, EQUAL_OR_LOWER, 0.1).light(0, 10, 0.5).seasons(SPRING, SUMMER, AUTUMN, WINTER).build()).build());
		...
		agricraft(context, "nethereed", new AgriPlant.Builder().stages16().chances(0.15, 0.015, 0.025).products(AgriProduct.builder().item("agricraft:netherite_sliver").count(1, 1, 0.25).build()).harvest(0).requirement(AgriRequirement.builder().humidity(DRY, EQUAL, 0.2).acidity(SLIGHTLY_ALKALINE, EQUAL, 0.2).nutrients(LOW, EQUAL, 0.2).dimensions(Level.NETHER.identifier()).seasons(SUMMER).blocks(AgriBlockCondition.builder().tag("agricraft:ores/netherite_scrap").build()).fluid(AgriFluidCondition.builder().fluid("minecraft:lava").build()).build()).modifiers(new AgriPlantModifierInfo(MinecraftPlantModifiers.ThornsPlantModifier.ID), new AgriPlantModifierInfo(MinecraftPlantModifiers.BushyPlantModifier.ID), new AgriPlantModifierInfo(MinecraftPlantModifiers.BurnPlantModifier.ID)).fireproof(true).build());
		...
		agricraft(context, "nitor_wart", new AgriPlant.Builder().stages16().chances(0.6, 0.025, 0.1).products(AgriProduct.builder().tag("agricraft:dusts/glowstone").count(1, 4, 0.9).build()).harvest(3).requirement(AgriRequirement.builder().humidity(ARID, EQUAL, 0.15).acidity(NEUTRAL, EQUAL, 0.2).nutrients(VERY_HIGH, EQUAL_OR_HIGHER, 0.1).blocks(AgriBlockCondition.builder().item("minecraft:glowstone").build()).build()).modifiers(new AgriPlantModifierInfo(MinecraftPlantModifiers.BrightnessPlantModifier.ID)).build());
	...
	public static void registerBiomesOPlenty(BootstrapContext<AgriPlant> context) {
		...
		r(context, "biomesoplenty", "glowshroom", new AgriPlant.Builder().seeds(AgriSeed.builder().item("biomesoplenty:glowshroom").build()).stages16().chances(0.75, 0.025, 0.1).products(AgriProduct.builder().item("biomesoplenty:glowshroom").count(2, 5, 1.0).build()).requirement(AgriRequirement.builder().humidity(DAMP, EQUAL, 0.15).acidity(NEUTRAL, EQUAL, 0.2).nutrients(MEDIUM, EQUAL_OR_LOWER, 0.2).light(0, 10, 0.5).seasons(SPRING, SUMMER, AUTUMN, WINTER).build()).modifiers(new AgriPlantModifierInfo(MinecraftPlantModifiers.BrightnessPlantModifier.ID)).build());
	...
	public static void registerBotania(BootstrapContext<AgriPlant> context) {
	...
	public static void r(BootstrapContext<AgriPlant> context, String modid, String plantId, AgriPlant plant) {
		context.register(ResourceKey.create(AgriApi.AGRIPLANTS, Identifier.fromNamespaceAndPath(modid, plantId)), plant);
	}
	...
	public static void botaniaFlower(BootstrapContext<AgriPlant> context, String color) {
